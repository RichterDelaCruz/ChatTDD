...
export function CodeViewer({ currentFile, allFiles, onFileSelect }: CodeViewerProps) {
  return (
    <div className="space-y-4">
            ...
            {allFiles.map((file) => (
              <div
                ...
                className={`
                  ...
                  ${file.id === currentFile.id ? "bg-primary text-primary-foreground" : "hover:bg-accent"}
                `}
      ...
      <div>
        ...
        <div className="space-y-2">
          {currentFile.structure.functions.length > 0 && (
            <div>
              <h3 className="text-sm font-medium text-muted-foreground">Functions:</h3>
              <ul className="list-disc list-inside">
                {currentFile.structure.functions.map((fn) => (
          ...
          {currentFile.structure.classes.length > 0 && (
            <div>
              <h3 className="text-sm font-medium text-muted-foreground">Classes:</h3>
              <ul className="list-disc list-inside">
                {currentFile.structure.classes.map((cls) => (
